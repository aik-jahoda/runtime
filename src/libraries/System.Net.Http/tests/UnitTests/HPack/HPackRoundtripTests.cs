...
//             void BeginWriteHeader(KnownHeader knownHeader)
//             {
//                 if (knownHeader.Http2StaticTableIndex != null)
//                 {
//                     int bytesWritten;

//                     while (!HPackEncoder.BeginEncodeLiteralHeaderFieldWithoutIndexing(knownHeader.Http2StaticTableIndex.GetValueOrDefault(), buffer.AvailableSpan, out bytesWritten))
//                     {
...
//                     while (!HPackEncoder.EncodeLiteralHeaderFieldWithoutIndexingNewName(knownHeader.Name, buffer.AvailableSpan, out bytesWritten))
//                     {
//                         buffer.EnsureAvailableSpace(buffer.AvailableLength + 1);
//                     }
//                     buffer.Commit(bytesWritten);
